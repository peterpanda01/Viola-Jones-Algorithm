...
videoPlayer = vision.VideoPlayer('Name', 'Circle','Position',...
...
numPts = 0;
frameCount = 0;
%%set(gcf,'CloseRequestFcn','runLoop = false; closereq');
...
while runLoop %%&& frameCount < 400
    ...
    if numPts < 10
        % Detection mode.
        bbox = circleDetector.step(videoFrameGray);
    ...
    %Alexnet   
    %%image(videoFrame);
    %%im = imresize(videoFrame,inputSize);
